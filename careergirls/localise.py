...
DOMAIN = "careergirls.org"
LINK_ATTRIBUTES = ["src", "href"]
DOWNLOAD_FOLDER = "downloads"
sample_url = "https://www.careergirls.org/educators-parents-mentors/school-counselors/"
...
def make_local(soup, page_url):
    ...
    with codecs.open(DOWNLOAD_FOLDER+"/index.html", "rb") as f:
        print(f.read())
...
def nice_html(soup):
    ...
    output.append(str(soup).encode('utf-8'))
