...
CHANNEL_NAME = "OpenUp Resources"              # Name of channel
CHANNEL_SOURCE_ID = "openupresources-testing" # Channel's unique id
CHANNEL_DOMAIN = "openupresources.org"         # Who is providing the content
