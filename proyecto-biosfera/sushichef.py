...
# Run constants
################################################################################
CHANNEL_NAME = "Proyecto Biosfera"              # Name of channel
CHANNEL_SOURCE_ID = "sushi-chef-proyecto-biosfera"    # Channel's unique id
CHANNEL_DOMAIN = "procomun.educalab.es/es"          # Who is providing the content
...
class MyChef(SushiChef):
    """
    This class uploads the Proyecto Biosfera channel to Kolibri Studio.
