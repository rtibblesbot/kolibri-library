...
# Run constants
################################################################################
CHANNEL_NAME = "LibreTexts"              # Name of channel
CHANNEL_SOURCE_ID = "sushi-chef-libretext-en"    # Channel's unique id
CHANNEL_DOMAIN = "libretexts.org"          # Who is providing the content
...
class MyChef(SushiChef):
    """
    This class uploads the LibreTexts channel to Kolibri Studio.
