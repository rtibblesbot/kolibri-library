...
# Run constants
################################################################################
CHANNEL_NAME = "Internet Archive - Universal Library"              # Name of channel
CHANNEL_SOURCE_ID = "sushi-chef-internet-archive-universal-library-en"    # Channel's unique id
...
class MyChef(SushiChef):
    """
    This class uploads the Internet Archive - Universal Library channel to Kolibri Studio.
