...
# Google sheet ID
SPREADSHEET_ID = '1adD5wGZTp6reOFHZY6CB7j9XLI5W9AHXGp1aaerGhLw'
...
class AimHiDescriptionRecord():
    ...
    def __init__(self, id, url, description, playlist, title = ''):
        self.video_id = id
        self.video_url = url
