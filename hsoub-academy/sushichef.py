...
CHANNEL_SOURCE_ID = "sushi-chef-hsoub-academy-ar"    # Channel's unique id
CHANNEL_DOMAIN = "academy.hsoub.com"          # Who is providing the content
...
class MyChef(SushiChef):
    """
    This class uploads the Hsoub Academy channel to Kolibri Studio.
