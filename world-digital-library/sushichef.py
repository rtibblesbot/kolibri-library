...
# Run constants
################################################################################
CHANNEL_NAME = "World Digital Library"              # Name of channel
CHANNEL_SOURCE_ID = "sushi-chef-world-digital-library-en"    # Channel's unique id
CHANNEL_DOMAIN = "www.wdl.org"          # Who is providing the content
...
class MyChef(SushiChef):
    """
    This class uploads the World Digital Library channel to Kolibri Studio.
